...
export const asignaturas = [
  ...
  { icon: Globe, text: "Entorno cliente", link: "/profesorado/asignaturas/entornoCliente", description: "Accede a los documentos de Entorno Cliente." },
  { icon: Server, text: "Entorno servidor", link: "/profesorado/asignaturas/entornoServidor", description: "Accede a los documentos de Entorno Servidor." },
  { icon: Database, text: "Bases de datos", link: "/profesorado/asignaturas/basesDeDatos", description: "Accede a los documentos de Base de datos." },
  { icon: Laptop2, text: "Entornos de Desarrollo", link: "/profesorado/asignaturas/entornosDesarrollo", description: "Accede a los documentos de Entornos de desarrollo." },
  { icon: Cpu, text: "Sistemas Informáticos", link: "/profesorado/asignaturas/sistemasInformaticos", description: "Accede a los documentos de Sistemas Informáticos." },
];
